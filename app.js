...
app.get('/addCandidates',function(req,res){
  res.render('add',{cans: candidates});
});

app.post('/add',function(req,res){
    if(!req.body.name)
    {
        res.render('add',{cans: candidates, msg: "Please Enter Candidate Name"});
    }
    else{
...
app.get('/vote',function(req,res){
 ...
 res.render('result',{ress: result});
});

app.get('/votingsummary', function(req,res){
   res.render('summary',{cans: candidates});
});
